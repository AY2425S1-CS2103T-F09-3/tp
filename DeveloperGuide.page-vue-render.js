...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit_guest")]),_v(" command updates the details of a guest in the address book. Users can specify the guest to be edited by providing the index number of that guest in the displayed guest list")])}
},function anonymous(
) {
