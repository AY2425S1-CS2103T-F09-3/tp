...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Forgetful wedding planner")]),_v(" "),_c('td',[_v("Create entries of guests/vendors with relevant details (1.name, 2. contact info, 3. Roles, 4.Notes)")]),_v(" "),_c('td',[_v("I can easily manage and track my guest/vendor list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Careful wedding planner")]),_v(" "),_c('td',[_v("Update details of current guests/vendors")]),_v(" "),_c('td',[_v("I can correct any mistakes or update any  additional information at any time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Organized wedding planner")]),_v(" "),_c('td',[_v("Read/Print out a guest/vendor list")]),_v(" "),_c('td',[_v("I can quickly access and reference their details.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Organized wedding planner")]),_v(" "),_c('td',[_v("Delete guests/vendors contacts that I no longer need")]),_v(" "),_c('td',[_v("my wedding planner stays organised")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Busy wedding planner")]),_v(" "),_c('td',[_v("Manage vendor contact details (photographers, caterers, florists)")]),_v(" "),_c('td',[_v("quickly reference and communicate with vendors")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Organised wedding planner")]),_v(" "),_c('td',[_v("Categorise attendees (family members, friends, vendors)")]),_v(" "),_c('td',[_v("keep track of different groups involved in the wedding")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User creates a new person with the required details (e.g. guest, vendor, task).")])]),_v(" "),_c('li',[_c('p',[_v("System adds the entry.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use Case: Read/Print Out Entries")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view or print all people.")])]),_v(" "),_c('li',[_c('p',[_v("System displays or prints the list of all people.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The input command was invalid (i.e. spelling error, etc.).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. System tells the user the command is unrecognised.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2a. No entries exist.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use Case: Categorise Persons")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to categorise a person (e.g., family, friends, coworkers).")])]),_v(" "),_c('li',[_c('p',[_v("System assigns attendees to the category.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User tries to create a duplicate category.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The input command was invalid (i.e. spelling error, etc.).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. System tells the user the command is unrecognised.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Size: The system should support storage for up to 500 guests and 50 vendors per wedding. Data size should not exceed 10 MB for each wedding event.")]),_v(" "),_c('li',[_v("Volatility: Guest lists and vendor details may change frequently, especially closer to the event date. Therefore, the system must accommodate dynamic data updates and edits.")]),_v(" "),_c('li',[_v("Persistency: All guest, vendor, and event information must be saved persistently in a txt file and remain accessible even after system shutdown or failure.")]),_v(" "),_c('li',[_v("Backup Frequency: Automatic backups of data should be created whenever the application is closed.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"5"}},[_c('li',[_v("Operating System: The system must be compatible with Windows, macOS, and Linux operating systems.")]),_v(" "),_c('li',[_v("Dependencies: Java 17 should be the core language.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"8"}},[_c('li',[_v("The system should be able to handle data storage for up to 100 simultaneous weddings, each containing up to 500 guests and 50 vendors.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("CLI (Command-Line Interface)")]),_v(": A text-based interface used to interact with software by typing commands.")]),_v(" "),_c('li',[_c('strong',[_v("CRUD Operations")]),_v(": Stands for Create, Read, Update, and Delete – the basic operations that can be performed on data.")]),_v(" "),_c('li',[_c('strong',[_v("RSVP")]),_v(": Short for \"Répondez S'il Vous Plaît,\" used to track guest attendance responses for an event.")]),_v(" "),_c('li',[_c('strong',[_v("Vendor")]),_v(": A supplier providing services or goods for a wedding, such as photographers, florists, caterers, etc.")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": A keyword or label assigned to an entry to categorize and easily filter it within the list.")]),_v(" "),_c('li',[_c('strong',[_v("Index")]),_v(": A numerical value representing the position of an entry in a list, used to reference and perform operations on the contact.")]),_v(" "),_c('li',[_c('strong',[_v("Status")]),_v(": A predefined label assigned to a task or attendee, representing their state (e.g., confirmed, pending, or canceled).")]),_v(" "),_c('li',[_c('strong',[_v("Task")]),_v(": A wedding-related activity that requires completion, such as booking a venue, sending invites, or coordinating with vendors.")]),_v(" "),_c('li',[_c('strong',[_v("Syntax")]),_v(": The specific structure and format required for entering commands in the CLI.")]),_v(" "),_c('li',[_c('strong',[_v("Stakeholders")]),_v(": Any individuals or organizations involved in the wedding, including family members, guests, and vendors.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 24 Sept 2024, 18:46:56 GMT+8]")])])])}
}];
