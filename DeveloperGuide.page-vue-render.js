...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit_guest")]),_v(" command updates the details of an existing guest in the address book. Users can specify the guest to be edited by providing the index number of that guest in the displayed guest list")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute")]),_v(" method of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" is called with the user input as the argument to begin the command execution")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" parses the user input (if valid) to create and return an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestCommandParser")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestCommandParser")]),_v(" parses the user input (if valid) to extract the prefixes and their corresponding values, which is used to create an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestDescriptor")]),_v(". An "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestCommand")]),_v(" is then created with the index provided in the user input and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestDescriptor")]),_v(" created.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" executes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestCommand")]),_v(", which retrieves the guest list from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" before accessing the target guest to edit. An edited guest with the updated name is then created using the existing target guest and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditGuestDescriptor")]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setPerson")]),_v(" method is then called to replace the existing target guest with the edited guest. Subsequently, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateFilteredPersonList")]),_v(" method from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" is called to update the filtered list.")]),_v(" "),_c('li',[_v("A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" containing the success message is then returned to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" and then back to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(" component")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command searches for all guests and vendors that match the given keyword(s) and displays them. The prefix specified in the command indicates the attribute to be searched. Do note that only one type of prefix should be used for each find command.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute")]),_v(" method of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" is called with the user input as the argument to begin the command execution")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" parses the user input (if valid) to create and return a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommandParser")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommandParser")]),_v(" parses the user input (if valid) to extract the prefix and its corresponding value, before calling the corresponding parse predicate method to create the corresponding predicate to be used. In this example, since the name prefix is specified, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("parseNamePredicate")]),_v(" method is called to create "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NameContainsKeywordsPredicate")]),_v(". A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" is then created with the predicate and returned.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" executes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(", which calls the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateFilteredPersonList")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" with the predicate as the argument. Subsequently, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("getFilteredGuestListCount")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("getFilteredVendorListCount")]),_v(" methods from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" to respectively obtain the number of guest(s) and vendor(s) that match the given keyword(s)")]),_v(" "),_c('li',[_v("A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" containing the success message is then returned to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" and then back to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(" component")])])}
},function anonymous(
) {
